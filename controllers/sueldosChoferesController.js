...
var SueldosChoferes=require('../models/SueldosChoferes');
var mongoosePaginate =require('mongoose-pagination');

function getSueldosChoferes (req,res){
  var page =1;
  var itemsPage=20;
  if(req.params.page){
    page=req.params.page;
  }
  SueldosChoferes.find().sort().paginate(page,itemsPage,(error,data,total)=>{
